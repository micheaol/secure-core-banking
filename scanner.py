...
class GitHubRepoAnalyzer:
    def __init__(self, target_org):
        ...
        # FIXED: Corrected domain layout with proper forward slashes
        self.base_url = f"https://api.github.com/{target_org}/repos"
...
def main():
    if len(sys.argv) != 2:
        ...
        print("[-] Example: python scanner.py hackthebox")
        sys.exit(1)
